    ...
    <div className="min-h-screen flex items-center justify-center bg-slate-950 p-4">
      <div className="w-full max-w-sm bg-white rounded-2xl shadow-2xl p-8">
        <div className="flex flex-col items-center mb-6">
          <div className="w-14 h-14 bg-gradient-to-br from-orange-400 to-orange-600 text-white rounded-2xl flex items-center justify-center font-black text-2xl shadow-lg mb-3">
            {(shopName || 'S').charAt(0)}
          </div>
          <h1 className="text-xl font-black text-slate-900">{shopName}</h1>
          <p className="text-xs text-slate-500 mt-1">{mode === 'signup' ? 'Create your shop account' : 'Sign in to your shop account'}</p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-3">
          <div className="relative">
            ...
            <input
              ...
              className="w-full pl-9 pr-3 py-3 rounded-xl border border-slate-300 text-sm focus:outline-none focus:ring-2 focus:ring-orange-400"
            />
          </div>
          <div className="relative">
        ...
        <button
          ...
          className="w-full text-center text-xs text-slate-500 mt-4 hover:text-orange-600 font-semibold"
        >
